...
const FoodLogDetailScreen = () => {
  const { logDetail } = useLocalSearchParams();
  const foodData = JSON.parse(logDetail);
  ...
  const [selectedMeasure, setSelectedMeasure] = useState(foodData[0].measures?.[0]?.label || "Serving");
  ...
  const servingSize = foodData[0].measures?.find((m) => m.label === selectedMeasure)?.weight || 1;

  const calculateNutrient = (nutrient) =>
    nutrient ? (((nutrient / 100) * servingSize) * parseFloat(quantity)).toFixed(2) : "N/A";
  ...
  const handleAddToLog = () => {
    ...
    Animated.timing(spinAnim, {
      ...
      const foodLogEntry = {
        ...
        mealType, 
        calories: `${calculateNutrient(food.nutrients?.ENERC_KCAL)}Kcal`,
        protein: `${calculateNutrient(food.nutrients?.PROCNT)}g`,
        fats: `${calculateNutrient(food.nutrients?.FAT)}g`,
        fiber: `${calculateNutrient(food.nutrients?.FIBTG)}g`,
        carbs: `${calculateNutrient(food.nutrients?.CHOCDF)}g`,
        sugar: `${calculateNutrient(food.nutrients?.SUGAR)}g`,
        cholestrol: `${calculateNutrient(food.nutrients?.CHOLE)}mg`,
        iron: `${calculateNutrient(food.nutrients?.FE)}mg`,
        magnesium: `${calculateNutrient(food.nutrients?.MG)}mg`,
        potassium: `${calculateNutrient(food.nutrients?.K)}mg`,
        sodium: `${calculateNutrient(food.nutrients?.NA)}mg`,
        zinc: `${calculateNutrient(food.nutrients?.ZN)}mg`,
        vitaminB12: `${calculateNutrient(food.nutrients?.VITB12)}mg`,
        VitaminB6: `${calculateNutrient(food.nutrients?.VITB6A)}mg`,
        VitaminC: `${calculateNutrient(food.nutrients?.VITC)}mg`,
        VitaminD: `${calculateNutrient(food.nutrients?.VITD)}mg`,
        thiamin: `${calculateNutrient(food.nutrients?.THIA)}mg`,
      };
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity onPress={()=>{router.push('/FoodLog')}} style={{ padding: 10 }}>
              ...
              <View style={styles.headerContent}>
                <Text style={styles.headerTitle}>{food.label}</Text>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.nutrientGrid}>
                <View style={styles.nutrientItem}>
                  ...
                  <View style={styles.nutrientInfo}>
                    <Text style={styles.nutrientValue}>
                      {calculateNutrient(food.nutrients?.ENERC_KCAL)}
                    </Text>
                ...
                <View style={styles.nutrientItem}>
                  ...
                  <View style={styles.nutrientInfo}>
                    <Text style={styles.nutrientValue}>
                      {calculateNutrient(food.nutrients?.PROCNT)} g
                    </Text>
                ...
                <View style={styles.nutrientItem}>
                  ...
                  <View style={styles.nutrientInfo}>
                    <Text style={styles.nutrientValue}>
                      {calculateNutrient(food.nutrients?.FAT)} g
                    </Text>
                ...
                <View style={styles.nutrientItem}>
                  ...
                  <View style={styles.nutrientInfo}>
                    <Text style={styles.nutrientValue}>
                      {calculateNutrient(food.nutrients?.CHOCDF)} g
                    </Text>
              ...
              <TouchableOpacity style={styles.expandButton}>
                <Text style={styles.expandText}>View More Nutrients</Text>
                <Ionicons name="chevron-down" size={16} color="#FF7043" />
              </TouchableOpacity>
            </View>
              ...
              <View style={styles.formGroup}>
                ...
                <View style={styles.pickerContainer}>
                  <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                    {foodData[0].measures?.map((measure) => (
                      <TouchableOpacity
                        key={measure.label}
                        style={[
