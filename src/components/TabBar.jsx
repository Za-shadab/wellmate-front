...
const TabBar = ({ state, descriptors, navigation }) => {
  const icons = {
    index: (color) => <MaterialCommunityIcons name="view-dashboard-outline" size={24} color={color} />,
    FoodLog: (color) => <Ionicons name="document-text-outline" size={24} color={color} />,
    two: (color) => <Ionicons name="scan-outline" size={32} color={color} />,
    mealplan: (color) => <Ionicons name="restaurant-outline" size={24} color={color} />,
